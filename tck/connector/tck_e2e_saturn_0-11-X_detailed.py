...
_test_case_name = "tck_e2e_saturn_0-11-X_detailed"
_now = datetime.now()
...
PROVIDER_CONNECTOR_CONFIG = {
    ...
    "dma_path": MANAGEMENT_PATH,  # Management API path
...
def consume_data_as_consumer(consumer_service, asset_id, provider_config=None, consumer_config=None):
    ...
    try:
        ...
        participant_id = catalog_data.get("participantId", catalog_data.get("participantId", provider_config["bpn"]))
        ...
        logger.info("  - Provider BPN: %s", provider_config['bpn'])
...
if __name__ == "__main__":
    _parser = argparse.ArgumentParser(
        description="Saturn E2E connector service example",
