...
from ....models.governance.policy_db_models import PolicyUsageRole
...
class PostgresMemoryGovernanceManager(MemoryGovernanceManager):
    ...
    def __init__(self, db_session: Session, **kwargs):
        ...
        """
        self.memory_manager = MemoryGovernanceManager()
        self.database_manager = PostgresGovernanceManager(db_session, **kwargs)
