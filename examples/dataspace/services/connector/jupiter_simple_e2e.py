...
_log_file = os.path.join(_log_dir, f"jupiter_simple_e2e_run_{_run_timestamp}.log")
...
logger = logging.getLogger("jupiter_simple_e2e")
...
if __name__ == "__main__":
    _parser = argparse.ArgumentParser(description="Jupiter Simple E2E example (legacy DSP)")
